...
Note that when we used `read.csv`, we assumed that the file extension was
appropriate. We can feel confident about this because we examined the file
earlier.
...
Lots of the most useful parts of R do not come preloaded when you install R.
...
We can then load the data with `read_excel`:
```{r, eval=FALSE}
