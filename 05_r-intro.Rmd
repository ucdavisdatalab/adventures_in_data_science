...
logi <- c("woof", "woof", "cat", "woof", "woof", "cat", "woof", "woof", "woof",
  "woof", "woof")
...
<!--
You can also use the dollar sign operator to create new columns or assign
values to columns. For instance, to create a column `pet`:
...
<!--
For example, we can use implicit coercion to succinctly
