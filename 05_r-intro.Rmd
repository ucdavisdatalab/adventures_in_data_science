...
R has many **functions** (reusable commands) built-in that allow you to compute mathematical operations, statistics, and other computing tasks. Code that uses a function is said to *call* that function. When you call a function, the values that you assign as input are called **arguments**. 
...
Some functions have multiple parameters and can accept multiple arguments.
...
R has some built in functions to help you inspect a vector and calculate basic statistics.
