...
## What's an Issue? {#sec-whats-an-issue}
...
the one in @fig-gh-issues. This is the issue tracker for the repository. In the
screenshot, there are no issues shown, but you might see issues in the tracker
on your screen.
...
](/images/week10/gh_issues.png){#fig-gh-issues}
...
You'll be taken to a page like the one in @fig-gh-new-issue.

![
GitHub's new issue page.
](/images/week10/gh_new_issue.png){#fig-gh-new-issue}
...
create the new issue and take you to its page, as in @fig-gh-issue-created.
Notice that GitHub assigns a unique number to each issue in a repository, so
that you can easily cross-reference issues. The issue in the screenshot is
number 19. GitHub also allows you to comment on your issue, which is a great
way to post follow-up information (for corrections to the issue description,
it's usually better to use the "Edit" option in the issue's "..." menu).

![
An issue just after being created.
](/images/week10/gh_issue_created.png){#fig-gh-issue-created}
...
@fig-gh-issue-comment.

![
A comment on an issue.
](/images/week10/gh_issue_comment.png){#fig-gh-issue-comment}
...
@sec-collaborating). But that won't be the case for most projects.
...
@sec-making-a-pull-request). Let's do this with the [Git sandbox
...
@fig-gh-create-fork, where you can edit the name and description for the fork.
Leave the name and description as-is, and click on the "Create fork" button.

![
GitHub's "Create a new fork" page.
](/images/week10/gh_fork.png){#fig-gh-create-fork}

After clicking the button, GitHub will take you to the page for the new fork,
as in @fig-gh-fork. Notice that the owner of the repository is you rather than
`ucdavisdatalab`. There are also two special buttons on the page: "Contribute"
and "Sync fork". We'll explain more about the "Contribute" button soon. The
"Sync fork" button merges the latest commits from the original repository into
your fork---you can use it to update your fork if the original repository
changes.

![
The fork's GitHub page.
](/images/week10/gh_fork_repo.png){#fig-gh-fork}
...
2. The local copy you cloned in @sec-branches-merges
...
there. The page should look something like @fig-gh-fork-commit.
...
## Making a Pull Request {#sec-making-a-pull-request}
...
](/images/week10/gh_fork_commit.png){#fig-gh-fork-commit}
...
GitHub page (as in @fig-gh-fork-commit).
...
you to a "Comparing changes" page like the one in @fig-gh-create-pull-request.
The page has spaces for a title and description, similar to when we created an
issue in @sec-whats-an-issue. In fact, pull requests are just a special kind of
issue.

![
GitHub's "Comparing changes" page, to create a new pull request.
](/images/week10/gh_create_pull_request.png){#fig-gh-create-pull-request}
...
in @fig-gh-pull-request.

![
The new pull request.
](/images/week10/gh_pull_request.png){#fig-gh-pull-request}
...
by the pull request, as in @fig-gh-pr-files-changed. You can also add comments
on specific lines. Examining the files changed is a great way to make sense of
what a pull request will actually do, and commenting on lines is a convenient
way to provide feedback to collaborators.

![
The "Files changed" tab on a pull request.
](/images/week10/gh_pr_files_changed.png){#fig-gh-pr-files-changed}
