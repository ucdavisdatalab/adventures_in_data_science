...
This lesson covers the background information on Version Control Software (VCS) to track and record changes to files on your local computer. It then focuses on Git Version Control Software to track and record changes to files on your local computer and how to connect it to the GitHub platform for remote/server based version control. 

## Learning Objectives  

After this lesson, you should be able to:  

* Understand the purpose of using Version Control Software (VCS)  
* Understand the different types of VCS: local/serve and centralized/distributed
