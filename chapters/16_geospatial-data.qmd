...
![A visual table of raster vs. vector data as continuous and discrete data.](/images/ch16/geometries_data_types.png)
...
![This is a screen capture of the output for the mapview function. Running this code in a regular R session (i.e. not in knitr or bookdown like we need to for this reader) will make an interactive map.](/images/ch16/mapview_monsters.png)
...
```
![Map of monster locations by continent](/images/ch16/mapview_monsters_byContinent.png)

It's hard to see, but there's a point in Michigan that's the wrong color for North America!

![Map of monster locations by continent zoomed in to the Great Lakes](/images/ch16/mapview_monsters_byContinent_zoom.png)
...
![Map of monster locations by lake name zoomed in to the Great Lakes](/images/ch16/mapview_monsters_byLake.png)

![Map of monster locations by lake name zoomed in to the Great Lakes](/images/ch16/mapview_monsters_byLake_zoom.png)
...
![Map of monster locations by monster name zoomed in to the Great Lakes](/images/ch16/mapview_monsters_byName.png)

![Map of monster locations by monster name zoomed in to the Great Lakes](/images/ch16/mapview_monsters_byName_zoom.png)
