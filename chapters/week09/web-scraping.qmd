...
`"tdi_53"`, instead. Usually the id of an element is unique, so this ensures
that we get the right section.

We can also add in a part about getting links now:

```{r}
div = html_elements(doc, xpath = "//div[@id = 'tdi_53']")
...
parse_article_links = function(page) {
  div = html_elements(page, xpath = "//div[@id = 'tdi_53']")
  links = html_elements(div, xpath = ".//h3/a")
...
#OR html_elements(doc, css = "#hello")
```
