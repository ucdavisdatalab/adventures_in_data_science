...
Let's start by parsing the example of a complete web page from earlier. The rvest function
`read_html` reads an HTML document. It accepts either an HTML string or a file
path (including URLs):
