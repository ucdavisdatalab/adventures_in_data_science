...
command. The command prompt character is used throughout these materials when
giving command examples. When working through materials, DO NOT ENTER the
command prompt. It will already be there telling you that the computer is ready
to receive your command.

<!-- FIXME: we probably shouldn't include the command prompt in examples -->
