...
As humans, we are used to accessing websites via a domain name (which we'll discuss shortly), but you also contant any server on the internet by simply typing the IP address into your browser address bar where you would normally enter the domain name.  For exampe, you can simply click on [169.237.102.141](169.237.102.141) to access the datalab website.
