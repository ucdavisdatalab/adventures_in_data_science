...
ggplot(survey, aes(x = distance.mi, y = time.min, label = major)) +
  geom_point() + geom_text(aes(color = major), size = 3, position = position_jitter(.5))
```
...
```{r}
ggplot(survey, aes(x = major)) + geom_bar(aes(color = pets)) +
  labs(title = "Majors in Responses", x = "Major", y = "Count")
```
...
```{r}
ggplot(survey, aes(x = major)) + geom_bar(aes(fill = pets)) +
  labs(title = "Majors in Responses", x = "Major", y = "Count")
```
...
```{r}
ggplot(survey, aes(x = major)) + geom_bar(aes(fill = pets), position = "dodge") +
  labs(title = "Majors in Responses", x = "Major", y = "Count")
```
