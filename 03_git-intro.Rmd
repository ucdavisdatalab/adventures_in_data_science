...
One of the advantages of working with a version control system like Git is the ability to maintain and syn repositories across multiple computers and users.  While there a variety of available, internet accesible remote repository hosting options, in this course, we will work with the [Github](https://github.com/) platform. 

### Creating a Github Account

In order to use Github, you must [create a github account] (https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F&source=header-home).  The preceding link will take you directly to the Github account sign-up page, or you can click on the 
